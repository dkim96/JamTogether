...
class QuestionCell: UITableViewCell {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        if(solved){
            ...
            self.backgroundColor = UIColor.init(hex: "FF473D")
        }
        ...
        nameLabel.leftAnchor.constraint(equalTo: upvoteButton.rightAnchor, constant: 10).isActive = true
        ...
        titleLabel.topAnchor.constraint(equalTo: nameLabel.bottomAnchor, constant: 10).isActive = true
