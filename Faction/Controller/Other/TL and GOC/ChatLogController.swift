...
//        collectionView?.scrollIndicatorInsets = UIEdgeInsets(top: 0, left: 0, bottom: 50, right: 0)
        ...
        if #available(iOS 11.0, *) {
            NSLayoutConstraint.activate([
                //inputContainerView.bottomAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.bottomAnchor),
                ...
                inputContainerView.widthAnchor.constraint(equalToConstant: self.view.frame.width)
                ])
        }
    ...
    lazy var inputContainerView: ChatInputContainerView = {
        ...
        chatInputContainerView.translatesAutoresizingMaskIntoConstraints = false
            chatInputContainerView = ChatInputContainerView(frame: CGRect(x: 0, y: 50, width: 300, height: 50))
